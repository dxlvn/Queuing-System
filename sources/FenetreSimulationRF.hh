#ifndef FENETRESIMULATIONRF_HH
#define FENETRESIMULATIONRF_HH
...
#include "SimulationRF.hh" //A ajouter au rapport
...
class FenetreSimulationRF : public QWidget
{
  ...
  public:
    ...
    **/
    FenetreSimulationRF(Reseau * r = NULL, Vue * v = NULL,QWidget * parent = NULL); //Ajouter le paramètre Reseau
    /**Destructeur**/
    ~FenetreSimulationRF();
    /**Méthode de récupération de la simulation
    @return une référence sur la simulation**/
    SimulationRF& getSimulation();                                              //A expliquer dans le compte-rendu
    /**Méthode de récupération de l'historique
    @return une référence sur l'historique**/
    HistoriqueRF& getHistorique();                                              //A expliquer dans le compte-rendu
    ...
    void resume();
    /**Méthode mettant en pause la simulation**/
    void pause();

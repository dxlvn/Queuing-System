...
void DialogInfosQueue::informations_clients()
{
    ...
    QString * res = new QString("<strong> Number | Wait time | Service Time </strong> <br>");
    ...
    fenetre_scroll->setMaximumSize(255,390);
    ...
    *res += "<strong>__________________________________</strong> <br>";
